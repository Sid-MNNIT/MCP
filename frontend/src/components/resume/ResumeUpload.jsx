...
const ResumeUpload = ({ uploadedFile, resumeMeta, isLoadingResume, onUpload, onRemove, onOpenResume }) => {
      ...
      <div className="resume-card">
        ...
        {isLoadingResume ? (
          ...
          <>
            ...
            <button onClick={triggerFilePicker} className="btn-replace btn-replace--block">
              Replace Resume
            </button>
          </>
